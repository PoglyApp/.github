...
## What is [Pogly](https://cloud.pogly.gg)?
...
Give the demo a try! https://demo.pogly.gg/
...
- Support for Twitch, Kick, or Youtube
- Fully managed with Pogly Cloud - free and paid options
- Various Element Types
    ...
    - Channel Emotes - Automatically pull the streamers Twitch, 7TV, BetterTTV, and FrankerFaceZ emotes for use
- OBS, Streamlabs, IRLToolkit, Prism, Meld Browser Source overlay compatibility
- Stream preview on editor canvas
- Advanced granular permissions system for editors
- Export/Import all Canvas Elements

## 

If you have any questions or concerns, pop by our [Discord](https://discord.gg/pogly) and ask!
